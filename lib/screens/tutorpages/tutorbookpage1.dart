...
class TutorBookPage1 extends StatefulWidget {
  final String tutorImage;

  TutorBookPage1({required this.tutorImage});

  @override
  _TutorBookPage1State createState() => _TutorBookPage1State();
}

class _TutorBookPage1State extends State<TutorBookPage1> {
