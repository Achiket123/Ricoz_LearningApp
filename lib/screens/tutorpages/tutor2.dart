...
//import 'package:learningapp/bookedpage.dart';
import 'package:learningapp/features/shadow.dart';
import 'package:learningapp/screens/tutorpages/tutorbookpage2.dart';
...
class TutorPage2 extends StatefulWidget {
  @override
  _TutorPage2State createState() => _TutorPage2State();
}

class _TutorPage2State extends State<TutorPage2> {
          ...
          GestureDetector(
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => TutorBookPage2(
  ...
  Widget _buildSingleGrayContainer(
      String imageName, String text1, String text2, String text3) {
